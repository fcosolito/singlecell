...
public class CellExpressionListDao {
        ...
        public void bulkSaveExpressions(Experiment e, List<GeneExpressionDto> expressionList) {
                ...
                List<PartialCellExpressionList> insertList = insertMap.values().stream().toList();
        ...
        public void fillExpressionLists() {
                ...
                MergeOperation merge = Aggregation.merge().intoCollection("cellExpressionList")
                ...
                Aggregation aggregation = Aggregation.newAggregation(
                                ...
                                projectLists,
                                merge)
                                .withOptions(AggregationOptions.builder().allowDiskUse(true).skipOutput().build());
